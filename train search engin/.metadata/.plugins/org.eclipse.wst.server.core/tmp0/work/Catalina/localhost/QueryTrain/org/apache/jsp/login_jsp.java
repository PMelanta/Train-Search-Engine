 ...
 * Generated at: 2018-12-03 17:16:09 UTC
...
DAO_Implement dao = new DAO_Implement();
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<h2>Welcome To Travelling Train!</h2>\r\n");
      out.write("\t\t\t<form action=\"\" onsubmit=\"return validate()\" method=\"post\">\r\n");
      out.write("\t\t\t\t<table cellpadding=\"5px\" style=\"margin: auto; margin-top: 50px;\"\r\n");
      out.write("\t\t\t\t\tcellspacing=\"15px\">\r\n");
      out.write("\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"2\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"font-weight: bold; font-size: 25px; color: #CCFF66; font-family: monospace;\">\r\n");
      out.write("\t\t\t\t\t\t\t\tLOGIN</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td\r\n");
      out.write("\t\t\t\t\t\t\tstyle=\"font-size: 20px; font-weight: bold; color: #CCFF66; font-family: monospace;\">USERNAME</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" id=\"username\" name=\"username\"\r\n");
      out.write("\t\t\t\t\t\t\tstyle=\"height: 18px; border-radius: 5px;\" required=\"\" /></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td\r\n");
      out.write("\t\t\t\t\t\t\tstyle=\"font-size: 20px; font-weight: bold; color: #CCFF66; font-family: monospace;\">PASSWORD</td>\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td style=\"float: right;\"><input type=\"submit\" id=\"submit\"\r\n");
      out.write("\t\t\t\t\t\t\tname=\"submit\" value=\"SUBMIT\"\r\n");
      out.write("\t\t\t\t\t\t\tstyle=\"height: 30px; background: #990000; color: #ffffff; width: 75px; border-radius: 5px;\" /></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t");
